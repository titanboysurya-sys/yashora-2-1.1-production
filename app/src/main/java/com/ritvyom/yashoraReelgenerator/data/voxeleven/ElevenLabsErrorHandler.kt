...
object ElevenLabsErrorHandler {
    ...
    /**
     * Parses any Exception into a user-friendly error result.
     */
    fun parseError(
        e: Throwable,
            ...
            is HttpException -> {
                ...
                when (code) {
                    ...
                    422 -> ElevenLabsErrorResult(
                        ...
                        userFriendlyMessage = "Model/Language Error (422): ${detailMsg ?: "The selected model '${currentModelId ?: "this model"}' cannot process this text or language option. Auto-switched to 'Multilingual v2'."}",
                        isModelOrLanguageMismatch = true,
                        fallbackModelId = "eleven_multilingual_v2",
                        httpStatusCode = code
                    )
